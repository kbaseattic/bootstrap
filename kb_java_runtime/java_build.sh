...
curl http://www.kbase.us/docs/build/jdk1.6.0_32.tar.gz > jdk1.6.0_32.tar.gz
tar zxvf jdk1.6.0_32.tar.gz -C /kb/runtime
ln -s /kb/runtime/jdk1.6.0_32 /kb/runtime/java

curl http://www.kbase.us/docs/build/apache-ant-1.8.3-bin.tar.gz > apache-ant-1.8.3-bin.tar.gz
tar zxvf apache-ant-1.8.3-bin.tar.gz -C /kb/runtime
ln -s /kb/runtime/apache-ant-1.8.3 /kb/runtime/ant
